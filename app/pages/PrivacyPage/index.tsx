...
export function meta() {
  const title = 'Interpro: политика конфиденциальности';
  const description =
    'На странице политики конфиденциальности Interpro вы найдете информацию о том, как мы собираем, храним и используем ваши данные.';
...
export default function PrivacyPage() {
  return (
    <StartPage>
      <div className="PrivacyPage px">
        <h1 className="PrivacyPage-title">Политика в отношении обработки персональных данных</h1>
        <Block title="Общие положения">
          <Paragraph>
            ...
            по обеспечению безопасности персональных данных, предпринимаемые ООО "ИНТЕРПРОЕКТ"
            (далее — Оператор).
          </Paragraph>
          ...
          <Paragraph number="1.2.">
            ...
            <a
              ...
              target="_blank"
              href={import.meta.env.VITE_ORIGINAL_URL}
            >
              {import.meta.env.VITE_ORIGINAL_URL}
            </a>
          </Paragraph>
        </Block>
        <Block title="2. Основные понятия, используемые в Политике">
        ...
        <Block title="3. Основные права и обязанности Оператора">
          <Paragraph number="3.1">Оператор имеет право:</Paragraph>
          <Paragraph>
          ...
          <Paragraph number="3.2">Оператор обязан:</Paragraph>
          <Paragraph>
        ...
        <Block title="4. Основные права и обязанности субъектов персональных данных">
          <Paragraph number="4.1.">Субъекты персональных данных имеют право:</Paragraph>
          <Paragraph>
          ...
          <Paragraph>— на осуществление иных прав, предусмотренных законодательством РФ.</Paragraph>
          <Paragraph number="4.2.">Субъекты персональных данных обязаны:</Paragraph>
        ...
        <Block title="5. Принципы обработки персональных данных">
        ...
        <Block title="6. Цели обработки персональных данных">
          <Paragraph number="Цель обработки:">
            <br /> Администратор обрабатывает персональные данные Пользователя для целей:
            <br /> - информационно-справочного обслуживания, в TOM числе предоставления информации о
            товарах Администратора; а также идентификацииПользователя Сервиса;
            <br />- идентификации Пользователя Сервиса;
            <br /> - заключения с Пользователем договоров купли-продажи
          </Paragraph>
          <br /> <br />
          <Paragraph number="Персональные данные:">
            <br />
            фамилия, имя, номера телефонов, наименования компаний
          </Paragraph>
          <br /> <br />
          <Paragraph number="Правовые основания:">
            <br />
            уставные (учредительные) документы Оператора
          </Paragraph>
          <br /> <br />
          <Paragraph number="Виды обработки персональных данных:">
            <br />
            Сбор, запись, систематизация, накопление, хранение, уничтожение и обезличивание
            персональных данных
          </Paragraph>
        </Block>
        <Block title="7. Условия обработки персональных данных">
        ...
        <Block title="8. Порядок сбора, хранения, передачи и других видов обработки персональных данных">
          <Paragraph>
        ...
        <Block
          title="9. Перечень действий, производимых Оператором с полученными
персональными данными"
        >
        ...
        <Block title="10. Трансграничная передача персональных данных">
          <Paragraph number="10.1.">
            Оператор до начала осуществления деятельности по трансграничной передаче персональных
        ...
        <Block title="11. Конфиденциальность персональных данных">
          <Paragraph>
        ...
        <Block title="12. Заключительные положения">
          <Paragraph number="12.1.">
...
export function Block({ children, title }: Props) {
  return (
    <div className="Block">
      <div className="Block_title">{title}</div>
      <div className="Block_container">{children}</div>
    </div>
  );
}
...
export function Paragraph({ number = '', children }: ParagraphProps) {
  return (
