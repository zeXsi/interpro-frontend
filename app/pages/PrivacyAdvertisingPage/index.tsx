import { Block, Paragraph } from 'pages/PrivacyPage';
import './styles.css';
import Link from 'shared/components/Link';

export default function PrivacyAdvertisingPage() {
  return (
    <div className="Advertising px">
      <h1 className="Advertising-title">Политика в&nbsp;отношении обработки персональных данных</h1>
      ...
      <Block title="1. Общие положения">
        <Paragraph>
          ...
          обеспечению безопасности персональных данных, предпринимаемые ООО &quot;Интерпроект&quot;
          (далее — Оператор).
        </Paragraph>
        ...
        <Paragraph number="1.2.">
          ...
          <Link to={import.meta.env.VITE_ORIGINAL_URL} typeLink="external">
      ...
      <Block title="6. Цели обработки персональных данных">
        <Paragraph>
          Цель обработки — информирование Пользователя посредством отправки электронных писем через
          электронную почту или мессенджеры WhatsApp, Telegram, Max или Viber.
        </Paragraph>
        <Paragraph>
      ...
      <Block title="8. Порядок сбора, хранения, передачи и других видов обработки персональных данных">
        ...
        <Paragraph number="8.5.">
          ...
          не несет ответственность за действия третьих лиц, в том числе указанных в настоящем пункте
          поставщиков услуг.
        </Paragraph>
      ...
      <Block title="9. Перечень действий, производимых Оператором с полученными персональными данными">
      ...
      <Block title="12. Заключительные положения">
        ...
        <Paragraph number="12.3.">
          ...
          <Link to={`${import.meta.env.VITE_ORIGINAL_URL}/privacy_advertising`} typeLink="external">
            {import.meta.env.VITE_ORIGINAL_URL}
            /privacy_advertising
          </Link>
          .
